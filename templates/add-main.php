...
<?php $classname = (isset($errors)) ? "form--invalid" : ""; ?>
    <form class="form form--add-lot container <? $classname ?>" action="add.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form__item <? $classname ?>">
                ...
                <select id="category" name="category">
                    ...
                    <?php foreach ($categories as $category) : ?>
                        <option value="<?= $category['id']; ?><?= getPostVal('category'); ?>"><?= $category['name']; ?></option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="form__item form__item--wide <? $classname ?>">
            ...
            <textarea id="message" name="message" value="<?= getPostVal('message'); ?>" placeholder="Напишите описание лота"></textarea>
